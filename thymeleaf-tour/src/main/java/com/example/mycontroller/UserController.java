...
public class UserController {
	...
	/*
	 * This method demonstrates the use @ModelAttribute annotation at the method
	 * level. This method creates a list and returns a list of countries
	 * 
	...
	/*
	 * This method is the variation of the above method. It will accept a model and
	 * save values in this model. These saved values will be available on the
	 * frontend to the custom
	 */
	@ModelAttribute
