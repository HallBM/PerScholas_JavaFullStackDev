...
public class MainEntryPoint {
	...
	public static void main(String[] args) {
		...
		// students from the above listOfStudents. Let’s see how to do it using
		// Predicate.
		...
		// Lambda expression implementing Predicate : Checking specialization of a
		// Student for “Mathematics”
		...
		Consumer<Student> percentageConsumer = (s) -> {
		...
		// Lambda expression implementing Function : Extracting only the names of all
		// students
