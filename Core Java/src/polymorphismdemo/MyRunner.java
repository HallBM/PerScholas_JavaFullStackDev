...
public class MyRunner {
	public static void main(String[] args) {
		...
		//shapeCircleObj.circleSpecificFunction(); // does not have access to Circle methods because is of type Circle
		...
		//downcasting
		//sObj.setColor("Navy Blue");
		//System.out.println(sObj);
		//Rectangle sObj2 = (Rectangle) sObj;
